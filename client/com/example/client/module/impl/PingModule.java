...
public class PingModule extends HudModule {
   private static final class_2960 ICON = class_2960.method_60655("modid", "textures/gui/icons/ping.png");
   ...
   private final BooleanSetting showText = new BooleanSetting("Ping Text", true);
         ...
         if (entry != null) {
            ...
            if (drawText) {
               if (vertical) {
                  ...
                  context.method_51439(mc.field_1772, class_2561.method_43470(bottomLine), bottomX, bottomY, textColor, false);
               } else {
   ...
   private void safeRefreshSize(int ping) {
