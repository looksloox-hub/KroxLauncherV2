...
public class DirectionModule extends HudModule {
   ...
   private final BooleanSetting showText = new BooleanSetting("Direction Text", true);
   ...
   public DirectionModule() {
      super("Direction", Category.HUD, (class_2960)null);
      this.x = 20;
      this.y = 190;
   ...
   public void render(class_332 context) {
      if (this.isEnabled() && mc != null && mc.field_1724 != null && mc.field_1772 != null) {
         String dir = this.getDirectionText();
         this.safeRefreshSize();
         ...
         if (drawText) {
            int textW = mc.field_1772.method_1727(dir);
            Objects.requireNonNull(mc.field_1772);
            int textH = 9;
            int textX = (this.width - textW) / 2;
            int textY = (this.height - textH) / 2;
            context.method_51439(mc.field_1772, class_2561.method_43470(dir), textX, textY, textColor, false);
         }
      }
   }
   ...
   private void safeRefreshSize() {
      if (mc != null && mc.field_1772 != null) {
         ...
         int pad = (int)this.spacing.getValue();
         int scalePad = Math.max(1, Math.round((float)pad * this.getScale()));
         int textW = this.showText.getValue() ? mc.field_1772.method_1727(dir) : 0;
         byte var10000;
   ...
   private String getDirectionText() {
      ...
      if (yaw > -45.0F && yaw <= 45.0F) {
         ...
         return yaw < -45.0F && yaw >= -135.0F ? "East" : "North";
      }
   }
