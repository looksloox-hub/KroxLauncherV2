...
public class CPSModule extends HudModule {
   private static final class_2960 ICON = class_2960.method_60655("modid", "textures/gui/icons/mouse.png");
   private static final int DEFAULT_BG_R = 16;
   private static final int DEFAULT_BG_G = 19;
   private static final int DEFAULT_BG_B = 29;
   private final BooleanSetting verticalFormat = new BooleanSetting("Vertical Format", false);
   ...
   public void onTick() {
      if (mc != null && mc.field_1724 != null && mc.field_1690 != null) {
         ...
         if (attackDown && !this.lastAttackState) {
            this.clicks.addLast(now);
         }

         this.lastAttackState = attackDown;

         while(!this.clicks.isEmpty() && now - (Long)this.clicks.peekFirst() > 1000L) {
   ...
   public void render(class_332 context) {
      if (this.isEnabled() && mc != null && mc.field_1724 != null && mc.field_1772 != null) {
         ...
         List<String> lines = this.buildLines(cps, vertical);
         ...
         if (vertical) {
            ...
            context.method_51439(mc.field_1772, class_2561.method_43470((String)lines.get(0)), scalePad, scalePad, textColor, false);
         }
      ...
      if (mc != null && mc.field_1772 != null && mc.field_1724 != null) {
         ...
         if (lines.isEmpty()) {
            ...
            if (vertical) {
               ...
               textW = mc.field_1772.method_1727((String)lines.get(0));
               Objects.requireNonNull(mc.field_1772);
               textH = 9;
            }
   ...
   private List<String> buildLines(int cps, boolean vertical) {
      List<String> lines = new ArrayList(2);
      if (vertical) {
         lines.add("CPS");
         lines.add(String.valueOf(cps));
      } else {
         lines.add("CPS: " + cps);
      }
