...
public class TimeModule extends HudModule {
   private static final class_2960 ICON = class_2960.method_60655("modid", "textures/gui/icons/time.png");
   ...
   private final BooleanSetting showText = new BooleanSetting("Time Text", true);
      ...
      if (this.isEnabled() && mc != null && mc.field_1724 != null && mc.field_1772 != null) {
         ...
         if (drawText) {
            if (vertical) {
               ...
               int bottomW = mc.field_1772.method_1727(time);
               ...
               context.method_51439(mc.field_1772, class_2561.method_43470(time), bottomX, bottomY, textColor, false);
            } else {
