...
public class FPSModule extends HudModule {
   private static final class_2960 ICON = class_2960.method_60655("modid", "textures/gui/icons/fps.png");
   ...
   private final BooleanSetting showText = new BooleanSetting("FPS Text", true);
   ...
   private void safeRefreshSize(int fps) {
