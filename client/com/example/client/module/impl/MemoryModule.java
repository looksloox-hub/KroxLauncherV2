...
public class MemoryModule extends HudModule {
   private static final class_2960 ICON = class_2960.method_60655("modid", "textures/gui/icons/memory.png");
   ...
   private final BooleanSetting showText = new BooleanSetting("RAM Text", true);
   ...
   public MemoryModule() {
      super("Memory", Category.HUD, ICON);
      this.x = 20;
      this.y = 140;
   ...
   public void render(class_332 context) {
      if (this.isEnabled() && mc != null && mc.field_1724 != null && mc.field_1772 != null) {
         ...
         long mb = used / 1024L / 1024L;
         this.safeRefreshSize((int)mb);
         boolean vertical = this.isVertical();
         boolean drawText = this.showText.getValue();
         String topLine = "RAM";
         String bottomLine = mb + "MB";
   ...
   private void safeRefreshSize(int mb) {
