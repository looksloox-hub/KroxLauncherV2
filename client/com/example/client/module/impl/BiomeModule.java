...
public class BiomeModule extends HudModule {
   private static final class_2960 ICON = class_2960.method_60655("modid", "textures/gui/icons/biome.png");
   ...
   private final BooleanSetting showText = new BooleanSetting("Biome Text", true);
      ...
      if (this.isEnabled() && mc != null && mc.field_1724 != null && mc.field_1687 != null && mc.field_1772 != null) {
         ...
         if (drawText) {
            if (vertical) {
               ...
               int bottomW = mc.field_1772.method_1727(biomeName);
               int topX = (this.width - topW) / 2;
               int bottomX = (this.width - bottomW) / 2;
               Objects.requireNonNull(mc.field_1772);
               int bottomY = scalePad + 9 + 1;
               context.method_51439(mc.field_1772, class_2561.method_43470(topLine), topX, scalePad, textColor, false);
               context.method_51439(mc.field_1772, class_2561.method_43470(biomeName), bottomX, bottomY, textColor, false);
            } else {
               context.method_51439(mc.field_1772, class_2561.method_43470(text), scalePad, scalePad, textColor, false);
            }
   ...
   private void safeRefreshSize() {
      if (mc != null && mc.field_1772 != null && mc.field_1724 != null && mc.field_1687 != null) {
         boolean vertical = this.isVertical();
         boolean drawText = this.showText.getValue();
         String topLine = "Biome";
         String bottomLine = this.getBiomeName();
   ...
   private String getBiomeName() {
      try {
         if (mc != null && mc.field_1687 != null && mc.field_1724 != null) {
            class_6880<class_1959> biome = mc.field_1687.method_23753(mc.field_1724.method_24515());
            return (String)biome.method_40230().map((k) -> prettifyBiomeName(k.method_29177().method_12832())).orElse("Unknown");
         } else {
            return "Unknown";
         }
